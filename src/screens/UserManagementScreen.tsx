...
const styles = StyleSheet.create({
  ...
  empty: { color: colors.textSecondary, padding: spacing.md, textAlign: 'center', fontSize: 14 },
  ...
  userName: { color: colors.textPrimary, fontWeight: '700', fontSize: 15, letterSpacing: -0.2 },
  ...
  roleBadgeText: { fontSize: 11, fontWeight: '800', color: '#0C0C0E' },
  role_user: { backgroundColor: colors.primary },
  role_vendor: { backgroundColor: '#C76900' },
  role_admin: { backgroundColor: colors.success },
  sectionHint: {
    fontSize: 10,
  ...
  roleButtonText: { color: colors.textSecondary, fontWeight: '600', fontSize: 12 },
  roleButtonTextActive: { color: '#0C0C0E', fontWeight: '800' },
  deleteButton: {
    marginTop: spacing.sm,
    paddingVertical: 8,
    borderRadius: radius.round,
